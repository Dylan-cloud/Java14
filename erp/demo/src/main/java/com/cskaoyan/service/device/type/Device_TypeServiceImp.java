package com.cskaoyan.service.device.type;


import com.cskaoyan.bean.device.Device_Type;
import com.cskaoyan.mapper.device.Device_TypeMapper;
...
public class Device_TypeServiceImp implements Device_TypeService {
    ...
    public List<Device_Type> selectIdAndName() {
        return device_typeMapper.selectIdAndName();
    }
