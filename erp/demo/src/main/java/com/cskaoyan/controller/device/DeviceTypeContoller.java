...
import com.cskaoyan.service.device.type.Device_TypeService;
...
public class DeviceTypeContoller {
    ...
    @ResponseBody
    public DeviceResponseVo insertDeviceType(@Valid Device_Type deviceType, BindingResult bindingResult) {
 ...
 /*       if (bindingResult.hasErrors()){
    ...
    @ResponseBody
    public DeviceResponseVo updateDeviceType(@Valid Device_Type deviceType) {
        DeviceResponseVo deviceResponseVo =new DeviceResponseVo();
